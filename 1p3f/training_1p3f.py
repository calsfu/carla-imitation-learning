...
from network_1p3f import ClassificationNetwork
from dataset_1p3f import get_dataloader
...
def train(data_folder, save_path):
    ...
    """
    infer_action = torch.load(save_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--save_path', default="./hw1/1p3f/model_1p3f.pth", type=str, help='path where to save your model in .pth format')
