...
from network_1p3c import RegressionNetwork

from dataset_1p3c import get_dataloader
...
def mse(batch_out, batch_gt):
    """
    Calculates the mean squared between the prediction of the network and
    ...
    return          float
    """
    return torch.nn.functional.mse_loss(batch_out, batch_gt)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--save_path', default="./hw1/1p3c/model_1p3c.pth", type=str, help='path where to save your model in .pth format')
